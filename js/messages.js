document.addEventListener('DOMContentLoaded', () => {
    ...
    function createProfilesDependsOfConversationStarted(data,isEmpty){
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            // crear contenedor
            const newMatchedProfile = $("<div></div>")
                .attr('id', 'profile' + profile.idConversation) // Asigna un id único basado en la conversación
                .addClass('cardProfileMessage') // Clase CSS para darle estilo
                .data('conversation-id', profile.idConversation); // Guarda el idConversation como dato
